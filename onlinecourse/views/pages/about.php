...
<head>
    ...
    <title>Giới thiệu - OnlineCourse</title>
...
<body>
    ...
    <div class="hero-section">
        <div class="container text-center">
            <h1 class="display-4 fw-bold mb-3">Giới thiệu về OnlineCourse</h1>
            <p class="lead">Nền tảng học lập trình trực tuyến hàng đầu Việt Nam</p>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="row mb-5">
                    <div class="col-lg-6">
                        ...
                        <p>OnlineCourse được thành lập với sứ mệnh mang đến kiến thức lập trình chất lượng cao cho mọi người tại Việt Nam. Chúng tôi tin rằng công nghệ giáo dục có thể thay đổi cuộc sống và mở ra những cơ hội mới cho học viên.</p>
                        
                        <h3 class="mt-4">Tầm nhìn</h3>
                        <p>Trở thành nền tảng đào tạo lập trình trực tuyến hàng đầu Việt Nam, nơi mỗi học viên đều có thể phát triển đầy đủ tiềm năng và trở thành những lập trình viên chuyên nghiệp.</p>
                    </div>
                    <div class="col-lg-6">
                        <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                             alt="Về chúng tôi" class="img-fluid rounded shadow">
                    </div>
                </div>
